/* ec.h - Western Digital WD8003E controller definitions */

#define EC0VEC  0x0d        /* vector */
#define EC0PORT 0x280       /* port */
#define EC0SMB  "0xd000"    /* shared memory base segment */
...
#define	MSK_RD2		0x20
#define SM_BASE		0xd000			/* default shared mem base */
