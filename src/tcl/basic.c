...
/* put this in tclint.h later */
extern int  Tcl_SnmpCmd _ANSI_ARGS_((ClientData clientData,
...
static CmdInfo builtInCmds[] = {
    ...
    {"snmp",        Tcl_SnmpCmd},           /* just a dummy for now */
...
#ifndef TCL_GENERIC_ONLY
    TclSetupEnv((Tcl_Interp *) iPtr); /* most of these routines not needed
                                         in XINU */
#endif
