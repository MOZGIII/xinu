...
/* ported from 68000 to MS DOS    C. Chlap 10.7.92 */
/* Was full of "integers are pointers" bugs */
#include <ctype.h>
...
/*  long lcval;          doesn't work with MSC 5.1, does work with QC 2.5*/
    int  lcval;
